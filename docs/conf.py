...
# -*- coding: utf-8 -*-
#
# ggf documentation build configuration file, created by
...
# Get version number from ggf._version file
import mock
...
rst_prolog = """
:github_url: https://github.com/GuckLab/ggf
"""
...
# This gets 'version'
exec(open(op.join(pdir, "ggf/_version.py")).read())
...
html_static_path = ['../examples/data/']


# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'ggfdoc'
...
latex_documents = [
    (master_doc, 'ggf.tex', 'ggf Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'ggf', 'ggf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ggf', 'ggf Documentation',
     author, 'ggf', 'One line description of project.',
     'Miscellaneous'),
]
